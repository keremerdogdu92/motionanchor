...
- ~~Expand SAM 2 readiness to cover Python 3.12, NumPy, OpenCV, PyTorch, SAM 2, CUDA, runner, checkpoint integrity, UI diagnostics, and a server-side execution guard.~~
